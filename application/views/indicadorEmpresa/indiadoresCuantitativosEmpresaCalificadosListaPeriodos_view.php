		...
		<table id="tablaPaginada" class="table table-bordered table-striped table-hover">
				<thead>
					<tr class="horizontalazul">
						...
						<th colspan="4" rowspan="2">GRAFICAS</th>
				...
				<th scope="col" class="clmn9">
                  <ul class="edittablamd">
                    <li> 
                      <a href="<?php echo base_url();?>indicadorEmpresa/verGraficaCuantitativosPorDimension/<?php echo $key->IdDatosTotales;?>/<?php echo $key->Periodo?>"><img src="<?php echo base_url();?>imagenes/grafica.png" width="30" height="28" alt=""/></a>
                    </li>
                  </ul>
                </th>
                <th scope="col" class="clmn9">
                  <ul class="edittablamd">
                    <li> 
                      <a href="<?php echo base_url();?>indicadorEmpresa/verGraficaCuantitativosPorSubDimension/<?php echo $key->IdDatosTotales;?>/<?php echo $key->Periodo?>"><img src="<?php echo base_url();?>imagenes/grafica2.png" width="30" height="28" alt=""/></a>
                    </li>
                  </ul>
                </th>
                <th scope="col" class="clmn9">
                  <ul class="edittablamd">
                    <li> 
                      <a href="<?php echo base_url();?>indicadorEmpresa/verGraficaCuantitativosPorPrincipiosSEPS/<?php echo $key->IdDatosTotales;?>/<?php echo $key->Periodo?>"><img src="<?php echo base_url();?>imagenes/grafica3.png" width="30" height="28" alt=""/></a>
                    </li>
                  </ul>
                </th>
                <th scope="col" class="clmn9">
                  <ul class="edittablamd">
                    <li> 
                      <a href="<?php echo base_url();?>indicadorEmpresa/verGraficaCuantitativosPorGrupoInteres/<?php echo $key->IdDatosTotales;?>/<?php echo $key->Periodo?>"><img src="<?php echo base_url();?>imagenes/grafica3.png" width="30" height="28" alt=""/></a>
                    </li>
                  </ul>
                </th>
                <th scope="col" class="clmn10" style="display:none">
                  <ul class="borrartablamd">
                    <li> 
                      <a href="#" onclick="eliminarIndicadorCualitativoEmpresaListaPeriodo('<?php echo $id; ?>','<?php echo $key->IdDatosTotales; ?>');"><img src="<?php echo base_url();?>imagenes/BORRAR1.png" width="30" height="28" alt=""/></a>
                    </li>
                  </ul>
                </th>
