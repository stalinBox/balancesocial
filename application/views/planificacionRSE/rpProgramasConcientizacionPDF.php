       ...
       if (!empty($programasConcientizacion))
         foreach ($programasConcientizacion as $key){
          ...
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->NombrePrograma.'</td>
            <td scope="col" >'.$key->TipoPrograma.'</td>
            <td scope="col" >'.$key->FechaPlanificacion.'</td>
            <td scope="col" >'.number_format($key->CostoPlanificado, 2).'</td>
            <td scope="col" >'.$key->Responsable.'</td>
            <td scope="col" >'.$key->EstadoPrograma.'</td>
            <td scope="col" >'.$key->ConvenioPrograma.'</td>
            <td scope="col" >'.$key->FechaInicioPrograma.'</td>
            <td scope="col" >'.$key->FechaFinPrograma.'</td>
            <td scope="col" >'.number_format($key->CostoPrograma, 2).'</td>
