       ...
       if (!empty($certificaciones))
         foreach ($certificaciones as $key){
          ...
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->NombreCertificacion.'</td>
            <td scope="col" >'.$key->TipoCertificacion.'</td>
            <td scope="col" >'.$key->EmisorCertificacion.'</td>
            <td scope="col" >'.$key->FechaDePlanificacion.'</td>
            <td scope="col" >'.$key->ObtenidoCertificacion.'</td>
            <td scope="col" >'.number_format($key->CostoCertificacion, 2).'</td>
            <td scope="col" >'.$key->FechaObtencionCertificacion.'</td>
