  ...
  <div id="tablapdf">
    <div id="tablaceldaspdf">
      <table border="1" cellspacing="0px" width="100%" class="tablclpelpdf">
       ...
       <tbody > ';       
       if (!empty($formasDeAtencion))
         foreach ($formasDeAtencion as $key){
          $html .= '
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->NombreFormaAtencion.'</td>
            <td scope="col" >'.$key->Ubicacion.'</td>
            <td scope="col" >'.$key->DescripcionFormaAtencion.'</td>
          </tr>
          ';
        }
        $html .='
