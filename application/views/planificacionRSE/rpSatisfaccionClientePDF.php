      ...
      <table border="1" cellspacing="0px" width="100%" class="tablclpelpdf">
        <thead>        
          <tr class="horizontalcabpdf">
           <th >Tipo</th>
           <th >Método</th>
           <th >Porcentaje de Satisfacción</th>
           <th >Observación</th>
           <th >Frecuencia</th>
       ...
       if (!empty($satisfaccionClientes))
         foreach ($satisfaccionClientes as $key){
          ...
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->TipoSatisfaccion.'</td>
            <td scope="col" >'.$key->Metodo.'</td>
            <td scope="col" >'.number_format($key->ResultadoSatisfaccion, 2)." %".'</td>
            <td scope="col" >'.$key->ObservacionSatisfaccion.'</td>
            <td scope="col" >'.$key->Frecuencia.'</td>
