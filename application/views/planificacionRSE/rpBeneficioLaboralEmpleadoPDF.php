      ...
      <table border="1" cellspacing="0px" width="100%" class="tablclpelpdf">
        <thead>        
          <tr class="horizontalcabpdf">           
           ...
           <th >N. Empleados con el Servicio</th>
           <th >Costo</th>
           <th >N. Días con el Beneficio</th>           
           <th >Observaciones</th>
       ...
       <tbody > ';
       if (!empty($beneficioLaboralEmpleado))
         foreach ($beneficioLaboralEmpleado as $key){
          $html .= '
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->TipoBeneficioLaboral.'</td>
            <td scope="col" >'.$key->NumEmpleadosConServicio.'</td>
            <td scope="col" >'.number_format($key->CostoTotalQueCubreEmpresa, 2).'</td>
            <td scope="col" >'.$key->NumDiasOtorgadoElBeneficio.'</td>
