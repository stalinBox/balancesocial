...
<script type="text/javascript">
  function verPDF(){
    ...
    window.open("<?php echo base_url()?>planificacionRSE/reporteSubModuloPublicoInternoPDF/"+seleccionado+"");    
  }
      ...
      <div id="cont3filtros">
        ...
        <section class="fltro1">
          ...
          <select name="selectTablaFiltro" id="selectTablaFiltro" class="selecfiltro">
            <option value="SaludLaboralEmpleado">Salud Laboral del Empleado</option>
            <option value="SeguroLaboral">Seguro Laboral</option>
            <option value="Empleado_DesarrolloProfesional">Desarrollo Profesional</option>
            <option value="ProgramasConcientizacion">Programas de Concientización</option>
            <option value="BeneficioLaboralEmpleado">Beneficio Laboral de Empleados</option>
