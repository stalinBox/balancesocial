      ...
      <table border="1" cellspacing="0px" width="100%" class="tablclpelpdf">
        <thead>        
          <tr class="horizontalcabpdf">
           ...
           <th >Sub -Tipo de Distribución</th>
       ...
       if (!empty($distribucionvalorEconomico))
         foreach ($distribucionvalorEconomico as $key){
          ...
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->TipoDistribucion.'</td>
            <td scope="col" >'.$key->SubTipoDistribucion.'</td>
            <td scope="col" >'.$key->NombreSubCuenta.'</td>
            <td scope="col" >'.$key->FechaMes.'</td>
            <td scope="col" >'.number_format($key->Saldo, 2).'</td>
