      ...
      <table border="1" cellspacing="0px" width="100%" class="tablclpelpdf">
        <thead>        
          <tr class="horizontalcabpdf">
           ...
           <th >Responsable</th>           
           <th >Etsado</th>
           <th >Costo que Aporta la Empresa</th>
           <th >Participantes</th>
           <th >Horas Ejecutadas</th>
           <th >Fecha Inicio de Ejecución</th>
       ...
       if (!empty($saludLaboralEmpleado))
         foreach ($saludLaboralEmpleado as $key){
          ...
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->NombreSaludLaboral.'</td>
            <td scope="col" >'.$key->TipoSaludLaboral.'</td>
            ...
            <td scope="col" >'.$key->EstadoSaludLaboral.'</td>
            <td scope="col" >'.number_format($key->CostoAportaOrganizacion, 2).'</td>
            <td scope="col" >'.$key->Participantes.'</td>
            <td scope="col" >'.$key->HorasEjecutadas.'</td>
            <td scope="col" >'.$key->FechaInicioEjecucion.'</td>
            <td scope="col" >'.$key->FechaFinEjecucion.'</td>
