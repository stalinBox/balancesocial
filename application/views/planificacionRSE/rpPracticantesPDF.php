      ...
      <table border="1" cellspacing="0px" width="100%" class="tablclpelpdf">
        <thead>        
          <tr class="horizontalcabpdf">
           ...
           <th >Nombres</th>
           <th >Apellidos</th>
           <th >Institución Procedente</th>
           <th >Tipo de Convenio</th>
           <th >N. Horas por Día</th>
           <th >Fecha de inicio de Prácticas</th>
           <th >Fecha  fin de Prácticas</th>
           <th >Contratado después de las Prácticas</th>
         </tr>
       </thead>
       <tbody > ';
       if (!empty($practicantes))
         foreach ($practicantes as $key){
          ...
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->CedulaPracticante.'</td>
            <td scope="col" >'.$key->NombresPracticante.'</td>
            <td scope="col" >'.$key->ApellidosPracticante.'</td>
            <td scope="col" >'.$key->InstitucionProcedente.'</td>
            <td scope="col" >'.$key->TipoConvenio.'</td>
            <td scope="col" >'.$key->CantidadHorasPorDia.'</td>
            <td scope="col" >'.$key->FInicioPracticas.'</td>
            <td scope="col" >'.$key->FFinPracticas.'</td>
            <td scope="col" >'.$key->ContratadoDespuesDePracticas.'</td>
          </tr>
          ';
        }
        echo "hola";
