       ...
       if (!empty($donaciones))
         foreach ($donaciones as $key){
          ...
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->Beneficiario.'</td>
            <td scope="col" >'.number_format($key->MontoDonacion, 2).'</td>
            <td scope="col" >'.$key->TipoDonacion.'</td>
            <td scope="col" >'.$key->FormaDonacion.'</td>
            <td scope="col" >'.$key->ObjetivoDonacion.'</td>
