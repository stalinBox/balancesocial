       ...
       if (!empty($proveedores))
         foreach ($proveedores as $key){
          ...
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->RucProveedor.'</td>
            <td scope="col" >'.$key->NombreProveedor.'</td>
            <td scope="col" >'.$key->TipoProveedor.'</td>
            <td scope="col" >'.$key->DireccionProveedor.'</td>
            <td scope="col" >'.$key->AlcanceProveedor.'</td>
            <td scope="col" >'.$key->TelefonoProveedor.'</td>
            <td scope="col" >'.$key->NacionalidadProveedor.'</td>
            <td scope="col" >'.$key->TipoEmpresaProveedor.'</td>
            <td scope="col" >'.$key->EstadoProveedor.'</td>
            <td scope="col" >'.$key->TipoEvaluacion.'</td>
            <td scope="col" >'.$key->PoliticasProveedor.'</td>
          ';
        }
        $html .='
      </tbody>
