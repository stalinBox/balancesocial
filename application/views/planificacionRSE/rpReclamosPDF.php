      ...
      <table border="1" cellspacing="0px" width="100%" class="tablclpelpdf">
        <thead>        
          <tr class="horizontalcabpdf">
           ...
           <th >Parte Denunciante</th>
           <th >Reclamos no Atendidos</th>
           <th >Reclamos Resueltos</th>
           <th >Costo de Reclamos</th>
           <th >Observaciones</th>
       ...
       if (!empty($reclamos))
         foreach ($reclamos as $key){
          ...
          <tr class="horizontalpdfcuerpo1">
            ...
            <td scope="col" >'.$key->TipoReclamos.'</td>
            <td scope="col" >'.$key->DenuncianteReclamos.'</td>
            <td scope="col" >'.number_format($key->NoAtendidosReclamos, 0).'</td>
            <td scope="col" >'.number_format($key->ResueltosReclamos, 0).'</td>
            <td scope="col" >'.number_format($key->CostoReclamos, 2).'</td>
            <td scope="col" >'.$key->ObservacionReclamos.'</td>
