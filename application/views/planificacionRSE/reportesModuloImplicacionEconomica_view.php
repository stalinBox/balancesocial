...
<script type="text/javascript">
  function verPDF(){
    ...
    window.open("<?php echo base_url()?>planificacionRSE/reporteSubModuloImplicacionEconomicaPDF/"+seleccionado+"");    
  }
      ...
      <div id="cont3filtros">
        ...
        <section class="fltro1">
          ...
          <select name="selectTablaFiltro" id="selectTablaFiltro" class="selecfiltro">
            <option value="GastosMesEmpresa">Gastos de Servicios</option>
            <option value="PoliticasAprobacionCreditoCalif">Políticas de Aprobación de Crédito</option>
            <option value="DistribucionValorEconomico">Disitribución del Valor Económico</option>
            <option value="SegmentosDeCredito">Segmentos de Crédito</option>
            <option value="PromedioSegmentosCreditos">Promedio Segmentos de Crédito</option>
            <option value="ImportanciaAuditoriaInternaSobreBalanceSocialCalif">Importancia de la Auditoria Interna Sobre el Balance Social</option>            
            <option value="ConcentracionAporteSocial">Concentración de Aportes Sociales</option>
          </select>
        </section>
      </div>
    </div>
