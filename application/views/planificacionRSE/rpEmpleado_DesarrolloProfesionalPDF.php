  ...
  <div id="tablapdf">
    <div id="tablaceldaspdf">
      <table border="1" cellspacing="0px" width="100%" class="tablclpelpdf">
       ...
       <tbody > ';
       if (!empty($empleado_DesarrolloProfesional))
         foreach ($empleado_DesarrolloProfesional as $key){
          $html .= '
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->Empleado.'</td>
            <td scope="col" >'.$key->DesarrolloProfesional.'</td>
            <td scope="col" >'.$key->HorasMes.'</td>
            <td scope="col" >'.$key->FechaPertenece.'</td>
