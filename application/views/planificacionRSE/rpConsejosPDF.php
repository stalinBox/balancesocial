      ...
      <table border="1" cellspacing="0px" width="100%" class="tablclpelpdf">
        <thead>        
          <tr class="horizontalcabpdf">
           ...
           <th >Tipo</th>
           <th >N. Integrantes</th>
           <th >N. Integrantes Hombres</th>
           <th >N. Integrantes Mujeres</th>           
           <th >Funciones</th>
           <th >Periodo</th>
         </tr>
       </thead>
       ...
       if (!empty($consejos))
         foreach ($consejos as $key){
          ...
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->NombreConsejos.'</td>
            <td scope="col" >'.$key->TipoConsejos.'</td>
            <td scope="col" >'.$key->IntegrantesConsejos.'</td>
            <td scope="col" >'.$key->NumeroHombres.'</td>
            <td scope="col" >'.$key->NumeroMujeres.'</td>
            <td scope="col" >'.$key->FuncionConsejos.'</td>
