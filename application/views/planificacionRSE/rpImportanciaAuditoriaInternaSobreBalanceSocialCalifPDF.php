      ...
      <table border="1" cellspacing="0px" width="100%" class="tablclpelpdf">
        <thead>        
          <tr class="horizontalcabpdf">
           <th >Pregunta Sobre la Importancia</th>
           <th >Calificación</th>
           <th >Fecha de Registro</th>
         </tr>
       </thead>
       <tbody > ';       
       if (!empty($importanciaAuditoriaInternaSobreBalanceSocialCalif))
         foreach ($importanciaAuditoriaInternaSobreBalanceSocialCalif as $key){
          $html .= '
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->Pregunta.'</td>
            <td scope="col" >'.$key->Calificacion.'</td>
