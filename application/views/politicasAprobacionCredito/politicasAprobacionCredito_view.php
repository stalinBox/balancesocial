...
<script type="text/javascript">
	...
	function nuevo(){
		window.location="<?php echo base_url()?>politicasAprobacionCredito/nuevoPAC"
	}
	function regresar(){
...
<div id="MANIPULACIONDATOS">
	...
	<div id="contenedor" style="margin:15px auto">
		<table id="tablaPaginada" class="table table-bordered table-striped table-hover text-centered table-sm" style="width:100%">
			...
			<tbody>
				<?php 
				if (!empty($politicasAprobacionCreditos)) {
					foreach ($politicasAprobacionCreditos as $key):
						$id   = base64_encode($key->IdAprobacionCredito);
					?>
					<tr class="horizontalcuerpo">
						<th scope="col" class="clmn1"><?php echo $key->NombreAprobacionCredito ?></th>
						<th scope="col" class="clmn1"><?php echo $key->Calificacion ?></th>
						<th scope="col" class="clmn9" style="display:none">
							<ul class="edittablamd">
								<li> 
									<a href="<?php echo base_url();?>empresa/editarLogro/<?php echo $key->IdAprobacionCredito;?>"><img src="<?php echo base_url();?>imagenes/ACTUALIZAR.png" width="30" height="28" alt=""/></a>
								</li>
							</ul>
						</th>
						<th scope="col" class="clmn10" style="display:none">
							<ul class="borrartablamd">
								<li>
									<a href="#" onclick="eliminarLogro('<?php echo $key->IdAprobacionCredito; ?>','<?php echo $key->NombreAprobacionCredito ?>');"><img src="<?php echo base_url();?>imagenes/BORRAR1.png" width="30" height="28" alt=Calificación""/></a>
								</li>
							</ul>
						</th>
					</tr>
