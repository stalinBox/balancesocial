...
<script type="text/javascript">
	...
	function nuevo(){
		window.location="<?php echo base_url()?>organismo/nuevaSesionAsambleaGeneral"
	}
	function regresar(){
...
<?php 
/*
echo "Permisos Sesiones de Asamblea ";
echo @$permisos[0]->Ver;
					...
					<tr class="horizontalcuerpo">
						...
						<th scope="col" class="clmn9" style="display:none">
							<ul class="edittablamd">
								<li> 
									<a href="<?php echo base_url();?>organismo/editarSesionAsambleaGeneral/<?php echo $key->IdSAG;?>"><img src="<?php echo base_url();?>imagenes/ACTUALIZAR.png" width="30" height="28" alt=""/></a>
								</li>
							</ul>
						</th>
						<th scope="col" class="clmn10" style="display:none">
							<ul class="borrartablamd">
								<li> 
									<a href="#" onclick="eliminarAsambleaGeneral('<?php echo $key->IdSAG; ?>','<?php echo $key->NombreReunion ?>');"><img src="<?php echo base_url();?>imagenes/BORRAR1.png" width="30" height="28" alt=""/></a>
								</li>
							</ul>
						</th>
					</tr>
...
<script type="text/javascript">
	...
	function eliminarAsambleaGeneral(id, nombre){
		...
		modalConfirm(function(confirm){
			if (confirm==true){
				var IdSA = id;
				$.post('<?php echo base_url(); ?>organismo/eliminarAsambleaGeneral',{IdSA: IdSA},function(data) {
				location.reload();
				});
			}
		});
