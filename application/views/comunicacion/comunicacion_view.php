		...
		<table id="tablaPaginada" class="table table-bordered table-striped table-hover text-centered table-sm" style="width:100%">
			<thead>
				<tr class="horizontalazul">
					<th scope="col" class="clmn1" style="display:none">IdComunicacion</th>
					<!-- <th scope="col" class="clmn1">RUC de Proveedor</th> -->
					<th scope="col" class="clmn1">Nombre</th>
					<th scope="col" class="clmn1">Medios</th>
					<th scope="col" class="clmn1">Tipo de Mecanismos</th>
					<th scope="col" class="clmn1">Descripción</th>
					<th scope="col" class="clmn1">Estado</th>
					<th scope="col" class="clmn1">Costo</th>
					<th scope="col" class="clmn1">Resultados</th>
			...
			<tbody>
				...
				if (!empty($comunicaciones)) {
					foreach ($comunicaciones as $key):
						$id   = base64_encode($key->IdComunicacion);
					?>
					<tr class="horizontalcuerpo">
						<th scope="col" class="clmn1" style="display:none"><?php echo $key->IdComunicacion ?></th>
						<!-- <th scope="col" class="clmn1"><?php echo $key->RucProveedor ?></th> -->
						<th scope="col" class="clmn1"><?php echo $key->NombreComunicacion ?></th>
						<th scope="col" class="clmn1"><?php echo $key->MediosDeInformacion ?></th>
						<th scope="col" class="clmn1"><?php echo $key->TipoMecanismos ?></th>
						<th scope="col" class="clmn1"><?php echo $key->DescripcionMecanismosDeComunicacion ?></th>
						<th scope="col" class="clmn1"><?php echo $key->EstadoComunicacion ?></th>
						<th scope="col" class="clmn1"><?php echo $key->CostoComunicacion ?></th>
						<th scope="col" class="clmn1"><?php echo $key->ResultadoDeComunicacion ?></th>
						<th scope="col" class="clmn9" style="display:none">
							<ul class="edittablamd">
								<li> 
									<a href="<?php echo base_url();?>comunicacion/editarComunicacion/<?php echo $key->IdComunicacion;?>"><img src="<?php echo base_url();?>imagenes/ACTUALIZAR.png" width="30" height="28" alt=""/></a>
								</li>
							</ul>
						</th>
						<th scope="col" class="clmn10" style="display:none">
							<ul class="borrartablamd">
								<li> 
									<a href="#" onclick="eliminarComunicacion('<?php echo $key->IdComunicacion; ?>','<?php echo $key->RucProveedor ?>');"><img src="<?php echo base_url();?>imagenes/BORRAR1.png" width="30" height="28" alt=""/></a>
								</li>
							</ul>
						</th>
					</tr>
...
// LLAMADA A LA FUNCION ELIMINAR Y LA VENTANA MODAL
	function eliminarComunicacion(id, nombre){
		...
		modalConfirm(function(confirm){
			if (confirm==true){
				var IdComunicacio=id;
				$.post('<?php echo base_url(); ?>comunicacion/eliminarComunicacion',{IdComunicacio: IdComunicacio},function(data) {
				location.reload();
				});
			}
		});
