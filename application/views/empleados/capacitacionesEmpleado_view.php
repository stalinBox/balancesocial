...
<?php 
/*
echo "Permisos Capacitaciones a Empleados ";
echo @$permisos[0]->Ver;
		...
		<table id="tablaPaginada" class="table table-bordered table-striped table-hover text-centered table-sm" style="width:100%">
			<thead>
				<tr class="horizontalazul">
					<th scope="col" class="clmn1" style="display:none">IdCapacitacionEmp</th>
					<th scope="col" class="clmn1">Nombre</th>
					<th scope="col" class="clmn1">Fecha Planificada</th>
					<th scope="col" class="clmn1">N. Orden</th>
					...
					<th scope="col" class="clmn1">Asistentes</th>
			...
			<tbody>
				...
				if (!empty($capacitacionesEmpleados)) {
					foreach ($capacitacionesEmpleados as $key):
						$id   = base64_encode($key->IdCapacitacionEmp);
					?>
					<tr class="horizontalcuerpo">
						<th scope="col" class="clmn1" style="display:none"><?php echo $key->IdCapacitacionEmp ?></th>
						<th scope="col" class="clmn1"><?php echo $key->NombreCapacitacion ?></th>
						<th scope="col" class="clmn1"><?php echo $key->FechaPlanificada ?></th>
						<th scope="col" class="clmn1"><?php echo $key->OrdenPedido ?></th>
						...
						<th scope="col" class="clmn9" style="display:none">
							<ul class="edittablamd">
								<li> 
									<a href="<?php echo base_url();?>empleado/editarCapacitacionEmpleado/<?php echo $key->IdCapacitacionEmp;?>"><img src="<?php echo base_url();?>imagenes/ACTUALIZAR.png" width="30" height="28" alt=""/></a>
								</li>
							</ul>
						</th>
						<th scope="col" class="clmn10" style="display:none">
							<ul class="borrartablamd">
								<li> 
									<a href="#" onclick="eliminarCapacitacionEmpleado('<?php echo $key->IdCapacitacionEmp; ?>','<?php echo $key->NombreCapacitacion ?>');"><img src="<?php echo base_url();?>imagenes/BORRAR1.png" width="30" height="28" alt=""/></a>
								</li>
							</ul>
						</th>
					</tr>
...
// LLAMADA A LA FUNCION ELIMINAR Y LA VENTANA MODAL
	function eliminarCapacitacionEmpleado(id, nombre){
		...
		modalConfirm(function(confirm){
			if (confirm==true){
				var IdCapacitacionEm=id;
				$.post('<?php echo base_url(); ?>empleado/eliminarCapacitacionEmpleado',{IdCapacitacionEm: IdCapacitacionEm},function(data) {
				location.reload();
				});
			}
		});
