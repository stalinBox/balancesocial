  ...
  <div id="tablapdf">
    <div id="tablaceldaspdf">
      <table border="1" cellspacing="0px" width="100%" class="tablclpelpdf">
       ...
       <tbody > ';
       if (!empty($IndicadoresCualitativosEmpresa))
         foreach ($IndicadoresCualitativosEmpresa as $key){  
          $html .= '
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->Fase.'</td>
            <td scope="col" >'.$key->IndicadorCualitativo.'</td>
            <td scope="col" >'.$key->Pregunta.'</td>
            <td scope="col" >'.$key->CodigoGRI.'</td>
