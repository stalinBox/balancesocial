      ...
      <table border="1" cellspacing="0px" width="100%" class="tablclpelpdf">
        <thead>        
          <tr class="horizontalcabpdf">
           ...
           <th >Discapacitado</th>
           <th >Estado de Educación</th>           
         </tr>
       </thead>
       <tbody > ';
         if (!empty($hijosEmpleadosEmpresa))
           foreach ($hijosEmpleadosEmpresa as $key){
           $html .= '
           <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->CedulaHijoEmpleado.'</td>
            <td scope="col" >'.$key->CedulaEmpleado.'</td>
            <td scope="col" >'.$key->ApellidosHijoEmpleado." ".$key->NombresHijoEmpleado.'</td>
            <td scope="col" >'.$key->FechaNacimientoHijoEmpleado.'</td>
            <td scope="col" >'.$key->DiscapacidadHijoEmpleado.'</td>
            <td scope="col" >'.$key->CentroEducacionHijoEmpleado.'</td>
          </tr>
          ';
        }
