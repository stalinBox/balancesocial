...
<div id="MANIPULACIONDATOS">
	<div id="menumanipulaciondatos">
		...
		<ul class="manipdatos">
			<li> 
				<a href="#" <?php if (@$permisos[0]->Eliminar == 1 OR @$admin == 1) { echo 'onclick="ocultarColumna(3,true)"';}else{echo 'onclick="denegado()"';}  ?> title="ELIMINAR"><img src="<?php echo base_url()?>imagenes/BORRAR-MENU.png" width="20" height="20" alt=""/></a>
			</li>
		</ul>
		<ul class="manipdatos2">
			<li> 
				...
				if (!empty($perfiles)) {
					foreach ($perfiles as $key) {
						...
						<tr class="horizontalcuerpo">
							...
							<th ><?php echo $key->Observacion; ?></th>
							<th scope="col" class="clmn9" style="display:none">
								 <ul class="edittablamd">
					            <li> 
					              <a href="<?php echo base_url();?>perfilUsuario/editarPerfil/<?php echo $key->IdPerfil;?>"><img src="<?php echo base_url();?>imagenes/ACTUALIZAR.png" width="30" height="28" alt=""/></a>
					            </li>
					          </ul>
							</th>
							<th class="clmn9" style="display:none">
								<ul class="borrartablamd">
					            <li> 
					              <a href="#" onclick="eliminarPerfil('<?php echo $key->IdPerfil; ?>','<?php echo $key->Nombre ?>');"><img src="<?php echo base_url();?>imagenes/BORRAR1.png" width="30" height="28" alt=""/></a>
					            </li>
					          </ul>
							</th>
						</tr>
...
// LLAMADA A LA FUNCION ELIMINAR Y LA VENTANA MODAL
	function eliminarPerfil(id, nombre){
		...
		modalConfirm(function(confirm){
			if (confirm==true){
				var idPer=id;
				$.post('<?php echo base_url(); ?>perfilUsuario/eliminarPerfil',{idPer: idPer},function(data) {
					console.log(data);
				location.reload();
				});
			}
