       ...
       if (!empty($usuariosEmpresa))
         foreach ($usuariosEmpresa as $key){
          ...
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->NombreUsuario.'</td>
            <td scope="col" >'.$key->ApellidosUsuario.'</td>
            <td scope="col" >'.$key->MailUsuario.'</td>
            <td scope="col" >'.$key->DireccionUsuario.'</td>
            <td scope="col" >'.$key->TelefonoUsuario.'</td>
            <td scope="col" >'.$key->CelularUsuario.'</td>
            <td scope="col" >'.$key->Perfil.'</td>
          </tr>
          ';
        }
        $html .='
