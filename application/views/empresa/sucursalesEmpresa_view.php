		...
		<table id="tablaPaginada" class="table table-bordered table-striped table-hover text-centered table-sm" style="width:100%">
			<thead>
				<tr class="horizontalazul">
					...
					<th scope="col" class="clmn1">Teléfonos</th>				
					<th scope="col" class="clmn1">Celulares</th>									
			...
			<tbody>
				...
				if (!empty($sucursalesEmpresa)) {
					...
					<tr class="horizontalcuerpo">
						...
						<th scope="col" class="clmn1"><?php echo $key->DireccionSucursal ?></th>
						<th scope="col" class="clmn1"><?php echo $key->Telefonos ?></th>
						<th scope="col" class="clmn1"><?php echo $key->Celulares ?></th>						
						<th scope="col" class="clmn1"><?php echo $key->Observaciones ?></th>						
						<th scope="col" class="clmn9" style="display:none">
							<ul class="edittablamd">
								<li> 
									<a href="<?php echo base_url();?>empresa/editarSucursalEmpresa/<?php echo $key->IdSucursal;?>"><img src="<?php echo base_url();?>imagenes/ACTUALIZAR.png" width="30" height="28" alt=""/></a>
								</li>
							</ul>
						</th>
						<th scope="col" class="clmn10" style="display:none">
							<ul class="borrartablamd">
								<li> 
									<a href="#" onclick="eliminarSucursalEmpresa('<?php echo $key->IdSucursal; ?>','<?php echo $key->DireccionSucursal ?>');"><img src="<?php echo base_url();?>imagenes/BORRAR1.png" width="30" height="28" alt=""/></a>
								</li>
							</ul>
						</th>
					</tr>
...
<script type="text/javascript">
	...
	function eliminarSucursalEmpresa(id, nombre){
		...
		modalConfirm(function(confirm){
			if (confirm==true){
				var IdSucu = id;
				$.post('<?php echo base_url(); ?>empresa/eliminarSucursalEmpresa',{IdSucu: IdSucu},function(data) {
				location.reload();
				});
			}
		});
