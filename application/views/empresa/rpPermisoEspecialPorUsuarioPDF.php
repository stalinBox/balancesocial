  ...
  <div id="tablapdf">
    <div id="tablaceldaspdf">
      <table border="1" cellspacing="0px" width="100%" class="tablclpelpdf">
       ...
       <tbody > ';       
       if (!empty($permisosEspecialPorUsuario))
         foreach ($permisosEspecialPorUsuario as $key){
          $html .= '
          <tr class="horizontalpdfcuerpo1">
            <td scope="col" >'.$key->ApellidosUsuario." ".$key->NombreUsuario.'</td>
            <td scope="col" >'.$key->MailUsuario.'</td>
            <td scope="col" >'.$key->Ver.'</td>
            <td scope="col" >'.$key->Agregar.'</td>
            <td scope="col" >'.$key->Actualizar.'</td>
            <td scope="col" >'.$key->Eliminar.'</td>            
          </tr>
          ';
        }
        $html .='
