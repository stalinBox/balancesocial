				...
				if (!empty($usuariosEmpresa)) {
					foreach ($usuariosEmpresa as $key) {
						...
						<tr class="horizontalcuerpo">
							...
							<th scope="col" class="clmn3"><?php echo $key->Mail; ?></th>
							...
							<th scope="col" class="clmn9" style="display:none">
								<ul class="edittablamd">
									<li> 
										<a href="<?php echo base_url();?>empresa/editarUsuario/<?php echo $key->IdUsuario;?>"><img src="<?php echo base_url();?>imagenes/ACTUALIZAR.png" width="30" height="28" alt=""/></a>
									</li>
								</ul>
							</th>                
							<th class="clmn10" style="display:none">                
								<ul class="borrartablamd">
									<li> 
										<a href="#" onclick="eliminarUsuarioEmpresa('<?php echo $id; ?>','<?php echo $key->IdUsuario ?>');"><img src="<?php echo base_url();?>imagenes/BORRAR1.png" width="30" height="28" alt=""/></a>
									</li>
								</ul>
							</th>
						</tr>
...
// LLAMADA A LA FUNCION ELIMINAR Y LA VENTANA MODAL
	function eliminarUsuarioEmpresa(id, nombre){
		...
		modalConfirm(function(confirm){
			if (confirm==true){
				var idUserEmp=id;
				$.post('<?php echo base_url(); ?>empresa/eliminarUsuarioEmpresa',{idUserEmp: idUserEmp},function(data) {
				location.reload();
				});
			}
		});
