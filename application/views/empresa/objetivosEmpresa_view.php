	...
	<div id="MANIPULACIONDATOS">
		<div id="menumanipulaciondatos">
			...
			<ul class="manipdatos2">
				<li> 
					<a href="#" <?php if (@$permisos[0]->Actualizar == 1 OR @$admin == 1) { echo 'onclick="ocultarColumna(2,true)"';}else{echo 'onclick="denegado()"';} ?> title="Editar"><img src="<?php echo base_url()?>imagenes/EDITAR.png" width="20" height="20" alt=""/></a>
				</li>
			</ul>
			<ul class="manipdatos">
				<li> 
					<a href="#" <?php if (@$permisos[0]->Eliminar == 1 OR @$admin == 1) { echo 'onclick="ocultarColumna(3,true)"';}else{echo 'onclick="denegado()"';} ?> title="Descartar"><img src="<?php echo base_url()?>imagenes/BORRAR-MENU.png" width="20" height="20" alt=""/></a>
				</li>
			</ul>
			<ul class="manipdatos2">
				<li> 
				...
				<tbody>
					...
					if (!empty($objetivosEmpresa)) {
						foreach ($objetivosEmpresa as $key): 
							$id   = base64_encode($key->IdObjetivosEmpresa);
						$filaAlterada++;
						if ($filaAlterada%2 == 0) { ?>
						<tr class="horizontalcuerpo">
							<th ><?php echo $key->ObjetivoObjetivosEmpresa ?></th>
							<th ><?php echo $key->DescripcionObjetivosEmpresa ?></th>
			<th scope="col" class="clmn9" style="display:none">
                  <ul class="edittablamd">
                    <li> 
                      <a href="<?php echo base_url();?>empresa/editarObjetivo/<?php echo $key->IdObjetivosEmpresa;?>"><img src="<?php echo base_url();?>imagenes/ACTUALIZAR.png" width="30" height="28" alt=""/></a>
                    </li>
                  </ul>
                </th>
                <th scope="col" class="clmn10" style="display:none">
                  <ul class="borrartablamd">
                    <li> 
                      <a href="#" onclick="eliminarObjetivo('<?php echo $id; ?>','<?php echo $key->ObjetivoObjetivosEmpresa ?>');"><img src="<?php echo base_url();?>imagenes/BORRAR1.png" width="30" height="28" alt=""/></a>
                    </li>
                  </ul>
                </th>
						</tr>
					...
					<tr class="horizontalcuerpo">
						<th scope="col" class="clmn1" ><?php echo $key->ObjetivoObjetivosEmpresa ?></th>
						<th scope="col" class="clmn1"><?php echo $key->DescripcionObjetivosEmpresa ?></th>						
									<th scope="col" class="clmn9" style="display:none">
                  <ul class="edittablamd">
                    <li> 
                      <a href="<?php echo base_url();?>empresa/editarObjetivo/<?php echo $key->IdObjetivosEmpresa;?>"><img src="<?php echo base_url();?>imagenes/ACTUALIZAR.png" width="30" height="28" alt=""/></a>
                ...
                <th scope="col" class="clmn10" style="display:none">
                  <ul class="borrartablamd">
                    <li> 
                      <a href="#" onclick="eliminarObjetivo('<?php echo $key->IdObjetivosEmpresa; ?>','<?php echo $key->ObjetivoObjetivosEmpresa ?>');"><img src="<?php echo base_url();?>imagenes/BORRAR1.png" width="30" height="28" alt=""/></a>
                    </li>
                  </ul>
                </th>
					</tr>
...
<script type="text/javascript">
	...
	function eliminarObjetivo(id, nombre){
		...
		modalConfirm(function(confirm){
			if (confirm==true){
				var idObjetivoEmp = id;
				$.post('<?php echo base_url(); ?>empresa/eliminarObjetivo',{idObjetivoEmp: idObjetivoEmp},function(data) {
				location.reload();
				});
			}
		});
