...
<div id="MANIPULACIONDATOS">
	...
	<div id="contenedor" style="margin:15px auto">
		<table id="tablaPaginada" class="table table-bordered table-striped table-hover text-centered table-sm" style="width:100%">
			...
			<tbody>
				<?php 
				if (!empty($logrosEmpresa)) {
					foreach ($logrosEmpresa as $key): ?>
					<tr class="horizontalcuerpo">
						<th ><?php echo $key->LogroLogrosEmpresa ?></th>
						<th ><?php echo $key->FechaLogrosEmpresa ?></th>
						<th ><?php echo $key->DetalleLogrosEmpresa ?></th>
						<th scope="col" class="clmn9" style="display:none">
							<ul class="edittablamd">
								<li> 
									<a href="<?php echo base_url();?>empresa/editarLogro/<?php echo $key->IdLogrosEmpresa;?>"><img src="<?php echo base_url();?>imagenes/ACTUALIZAR.png" width="30" height="28" alt=""/></a>
								</li>
							</ul>
						</th>
						<th scope="col" class="clmn10" style="display:none">
							<ul class="borrartablamd">
								<li> 
									<a href="#" onclick="eliminarLogro('<?php echo $key->IdLogrosEmpresa; ?>','<?php echo $key->LogroLogrosEmpresa ?>');"><img src="<?php echo base_url();?>imagenes/BORRAR1.png" width="30" height="28" alt=""/></a>
								</li>
							</ul>
						</th>
					</tr>
