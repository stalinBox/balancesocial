...
<script type="text/javascript">
	...
	function agregar(){
		window.location="<?php echo base_url()?>indicador/guardarIndicadoresSeleccionadosPorFiltro"
	}
	function regresar(){
...
<div id="TAB">
	<div id="MANIPULACIONDATOS">
	   <div id="tablamanipulaciondatos">
		<form action="<?php echo base_url()?>indicador/guardarIndicadoresSeleccionadosPorFiltro" id="form1" method="POST">		
	...
	<tr class="filagris">
		...
		<th scope="col" class="clmn7" style="display:none">
			<a href="<?php echo base_url();?>indicadorEmpresa/editarIndicadorCuantitativo/<?php echo $key->IdIndicador;?>">
