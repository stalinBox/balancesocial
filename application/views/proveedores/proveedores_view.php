...
<script type="text/javascript">
	...
	function regresar(){
		window.location="<?php echo base_url()?>proveedor";
	}
	function denegado() {
		...
		<table id="tablaPaginada" class="table table-bordered table-striped table-hover text-centered table-sm" style="width:100%">
			<thead>
				<tr class="horizontalazul">
					<th scope="col" class="clmn1">RUC</th>
					<th scope="col" class="clmn1">Nombre</th>
					<th scope="col" class="clmn1">Tipo</th>
					<th scope="col" class="clmn1">Dirección</th>
					<th scope="col" class="clmn1">Alcance</th>
					<th scope="col" class="clmn1">Nacionalidad</th>
					<th scope="col" class="clmn1">Tipo</th>
					<th scope="col" class="clmn1">Estado</th>
					<th scope="col" class="clmn1">Tipo de Evaluación</th>
			...
			<tbody>
				...
				if (!empty($proveedores)) {
					foreach ($proveedores as $key):
						$id   = base64_encode($key->IdProveedor);
					?>
					<tr class="horizontalcuerpo">
						<th scope="col" class="clmn1"><?php echo $key->RucProveedor ?></th>
						<th scope="col" class="clmn1"><?php echo $key->NombreProveedor ?></th>
						<th scope="col" class="clmn1"><?php echo $key->TipoProveedor ?></th>
						<th scope="col" class="clmn1"><?php echo $key->DireccionProveedor ?></th>
						<th scope="col" class="clmn1"><?php echo $key->AlcanceProveedor ?></th>
						<th scope="col" class="clmn1"><?php echo $key->NacionalidadProveedor ?></th>
						<th scope="col" class="clmn1"><?php echo $key->TipoEmpresaProveedor ?></th>
						<th scope="col" class="clmn1"><?php echo $key->EstadoProveedor ?></th>
						<th scope="col" class="clmn1"><?php echo $key->TipoEvaluacion ?></th>
						<th scope="col" class="clmn9" style="display:none">
							<ul class="edittablamd">
								<li> 
									<a href="<?php echo base_url();?>proveedor/editarProveedor/<?php echo $key->IdProveedor;?>"><img src="<?php echo base_url();?>imagenes/ACTUALIZAR.png" width="30" height="28" alt=""/></a>
								</li>
							</ul>
						</th>
						<th scope="col" class="clmn10" style="display:none">
							<ul class="borrartablamd">
								<li> 
									<a href="#" onclick="eliminarProveedor('<?php echo $key->IdProveedor; ?>','<?php echo $key->NombreProveedor ?>');"><img src="<?php echo base_url();?>imagenes/BORRAR1.png" width="30" height="28" alt=""/></a>
								</li>
							</ul>
						</th>
					</tr>
...
// LLAMADA A LA FUNCION ELIMINAR Y LA VENTANA MODAL
	function eliminarProveedor(id, nombre){
		...
		modalConfirm(function(confirm){
			if (confirm==true){
				var IdProv=id;
				$.post('<?php echo base_url(); ?>proveedor/eliminarProveedor',{IdProv: IdProv},function(data) {
				location.reload();
				});
			}
		});
