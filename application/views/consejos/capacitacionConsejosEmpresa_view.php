...
<?php 
/*
echo "Permisos Capacitaciones a Consejos ";
echo @$permisos[0]->Ver;
...
<div id="MANIPULACIONDATOS">
	<div id="menumanipulaciondatos">
		...
		<ul class="manipdatos2">
			<li> 
				<a href="#" <?php if (@$permisos[0]->Actualizar == 1 OR @$admin == 1) { echo 'onclick="ocultarColumna(12,true)"';}else{echo 'onclick="denegado()"';} ?> title="Editar"><img src="<?php echo base_url()?>imagenes/EDITAR.png" width="20" height="20" alt=""/></a>
			</li>
		</ul>
		<ul class="manipdatos">
			<li> 
				<a href="#" <?php if (@$permisos[0]->Eliminar == 1 OR @$admin == 1) { echo 'onclick="ocultarColumna(13,true)"';}else{echo 'onclick="denegado()"';} ?> title="Descartar"><img src="<?php echo base_url()?>imagenes/BORRAR-MENU.png" width="20" height="20" alt=""/></a>
			</li>
		</ul>
		<ul class="manipdatos2">
			<li> 
		...
		<table id="tablaPaginada" class="table table-bordered table-striped table-hover text-centered table-sm" style="width:100%">
			<thead>
				<tr class="horizontalazul">
					<th scope="col" class="clmn1" style="display:none">IdCapacitacionCons</th>
					...
					<th scope="col" class="clmn1">Participante Capacitados</th>
					<th scope="col" class="clmn1">Horas Ejecutadas</th>
					<th scope="col" class="clmn1">Fecha de Ejecución</th>
			...
			<tbody>
				<?php 
				if (!empty($capacitacionConsejosEmpresa)) {
					foreach ($capacitacionConsejosEmpresa as $key):
						$id   = base64_encode($key->IdCapacitacionCons);
					?>
					<tr class="horizontalcuerpo">
						<th scope="col" class="clmn1" style="display:none"><?php echo $key->IdCapacitacionCons ?></th>
						<th scope="col" class="clmn1"><?php echo $key->NombreCapacitacion ?></th>
						<th scope="col" class="clmn1"><?php echo $key->FechaPlanificada ?></th>
						<th scope="col" class="clmn1"><?php echo $key->TipoCapacitacion ?></th>
						<th scope="col" class="clmn1"><?php echo $key->Presupuesto ?></th>
						<th scope="col" class="clmn1"><?php echo $key->HorasPlanificadas ?></th>
						<th scope="col" class="clmn1"><?php echo $key->ParticipantesEsperadosPOA ?></th>
						<th scope="col" class="clmn1"><?php echo $key->EstadoCapacitacion ?></th>
						<th scope="col" class="clmn1"><?php echo $key->ParticipantesCapacitados ?></th>
						<th scope="col" class="clmn1"><?php echo $key->HorasEjecutadas ?></th>
						<th scope="col" class="clmn1"><?php echo $key->FechaEjecucion ?></th>
						<th scope="col" class="clmn1"><?php echo $key->Costo ?></th>
						<th scope="col" class="clmn9" style="display:none">
							<ul class="edittablamd">
								<li> 
									<a href="<?php echo base_url();?>consejo/editarCapacitacionConsejos/<?php echo $key->IdCapacitacionCons;?>"><img src="<?php echo base_url();?>imagenes/ACTUALIZAR.png" width="30" height="28" alt=""/></a>
								</li>
							</ul>
						</th>
						<th scope="col" class="clmn10" style="display:none">
							<ul class="borrartablamd">
								<li> 
									<a href="#" onclick="eliminarCapacitacionConsejos('<?php echo $key->IdCapacitacionCons; ?>','<?php echo $key->NombreCapacitacion ?>');"><img src="<?php echo base_url();?>imagenes/BORRAR1.png" width="30" height="28" alt=""/></a>
								</li>
							</ul>
						</th>
					</tr>
...
// LLAMADA A LA FUNCION ELIMINAR Y LA VENTANA MODAL
	function eliminarCapacitacionConsejos(id, nombre){
		...
		modalConfirm(function(confirm){
			if (confirm==true){
				var IdCapacitacionCon = id;
				$.post('<?php echo base_url(); ?>Consejo/eliminarConsejo',{IdCapacitacionCon: IdCapacitacionCon},function(data) {
				location.reload();
				});
			}
		});
