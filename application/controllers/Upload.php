...
class Upload extends CI_Controller {
    ...
    function index() {
        ...
        $this->load->view('usuarios/upload_view');
    }
    ...
    function do_upload() {
        ...
        $config['upload_path'] = './imageSistem/';
        ...
        if (!$this->upload->do_upload()) {
            ...
            $this->load->view('usuarios/upload_view', $error);
        } else {
        ...
        //ENVÍAMOS LOS DATOS AL MODELO PARA HACER LA INSERCIÓN
            ...
            $data['titulo'] = $titulo;
            $data['imagen'] = $imagen;
            $this->load->view('usuarios/imagen_subida_view', $data);
        }
        }else{
    ...
    function _create_thumbnail($filename){
        ...
        $config['source_image'] = 'imageSistem/'.$filename;
        $config['create_thumb'] = TRUE;
        $config['maintain_ratio'] = TRUE;
        //CARPETA EN LA QUE GUARDAMOS LA MINIATURA
        $config['new_image']='imageSistem/thumbs/';
        $config['width'] = 150;
        $config['height'] = 150;
